...
class LocationTracking extends StatefulWidget {
  static final String locationTrackingRoute = "/LocationTrackingRoute";
...
class _LocationTrackingState extends State<LocationTracking> {
  ...
  LatLng destinationLatlng = LatLng(22.172742, 75.586923);
  ...
  void setPolylinesInMap() async {
    ...
    print(
        "polyline------------------------------------------------------------------------------------------------");
    polylineCoordinates.add(LatLng(28.432864, 77.002563));
